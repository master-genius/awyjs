...
module.exports = function () {
    ...
    */
    ...
    this.router.any = function(api_path, callback, name='') {
        the.map(the.methodList, api_path, callback, name);
    };
    ...
    */
    ...
    /*
        添加中间件。
        @param {function} midcall 中间件
        @param {RegExp|string|Array} preg 正则|字符串|数组表示执行中间件的匹配规则。
